...
public class Communication2event implements ICommunication {
	...
	/* (non-Javadoc)
	 * @see otsopack.commons.network.ICommunication#demand(java.lang.String, otsopack.commons.data.Template, long, otsopack.commons.network.communication.demand.local.ISuggestionCallback)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see otsopack.commons.network.ICommunication#suggest(java.lang.String, otsopack.commons.data.Graph)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see otsopack.commons.network.ICommunication#callbackIfIHaveResponsabilityOverThisKnowlege(java.lang.String, otsopack.commons.data.Graph)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see otsopack.commons.network.ICommunication#hasAnyPeerResponsabilityOverThisKnowlege(java.lang.String, otsopack.commons.data.Graph)
	 */
	@Override
