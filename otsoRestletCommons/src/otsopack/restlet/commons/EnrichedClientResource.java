...
public class EnrichedClientResource extends ClientResource {
     ...
     * {@link EnrichedClientResource} and invokes the {@link #wrap(Class)} method.
     * 
     * @param <T>
     * @param context
     *            The context.
    ...
    public static <T> T create(Context context, Reference reference,
        ...
        EnrichedClientResource clientResource = new EnrichedClientResource(context, reference);
     ...
     * Empty constructor.
     */
    protected EnrichedClientResource() {
    }
     ...
     */
    public EnrichedClientResource(EnrichedClientResource resource) {
     ...
     *            The target URI.
     */
    public EnrichedClientResource(Context context, java.net.URI uri) {
     ...
     *            The target URI.
     */
    public EnrichedClientResource(Context context, Method method, java.net.URI uri) {
     ...
     *            The target reference.
     */
    public EnrichedClientResource(Context context, Method method, Reference reference) {
     ...
     *            The target URI.
     */
    public EnrichedClientResource(Context context, Method method, String uri) {
        this(context, method, new Reference(uri));
    }
     ...
     *            The target reference.
     */
    public EnrichedClientResource(Context context, Reference reference) {
     ...
     */
    public EnrichedClientResource(Context context, Request request, Response response) {
        if (context == null) {
            context = Context.getCurrent();
        }

        // Don't remove this line.
        // See other constructor EnrichedClientResource(Context, Method, Reference)
     ...
     *            The target URI.
     */
    public EnrichedClientResource(Context context, String uri) {
        this(context, Method.GET, uri);
    }
     ...
     *            The target URI.
     */
    public EnrichedClientResource(java.net.URI uri) {
     ...
     *            The target URI.
     */
    public EnrichedClientResource(Method method, java.net.URI uri) {
     ...
     *            The target reference.
     */
    public EnrichedClientResource(Method method, Reference reference) {
     ...
     *            The target URI.
     */
    public EnrichedClientResource(Method method, String uri) {
        this(Context.getCurrent(), method, uri);
    }
     ...
     *            The target reference.
     */
    public EnrichedClientResource(Reference reference) {
     ...
     *            The handled response.
     */
    public EnrichedClientResource(Request request, Response response) {
     ...
     *            The target URI.
     */
    public EnrichedClientResource(String uri) {
        this(Context.getCurrent(), null, uri);
    }
     ...
     * @throws ResourceException
     */
    public EnrichedClientResource getChild(Reference relativeRef)
            throws ResourceException {
        EnrichedClientResource result = null;

        if ((relativeRef != null) && relativeRef.isRelative()) {
            result = new EnrichedClientResource(this);
    ...
    public <T> T getChild(Reference relativeRef,
        ...
        T result = null;
        EnrichedClientResource childResource = getChild(relativeRef);
     ...
     * @throws ResourceException
     */
    public EnrichedClientResource getChild(String relativeUri) throws ResourceException {
     ...
     */
    public EnrichedClientResource getParent() throws ResourceException {
        EnrichedClientResource result = null;
    ...
    public <T> T getParent(Class<? extends T> resourceInterface)
        ...
        EnrichedClientResource parentResource = getParent();
    ...
    public <T> T wrap(Class<? extends T> resourceInterface) {
        ...
        final EnrichedClientResource clientResource = this;
            ...
            public Object invoke(Object proxy,
                ...
                if (javaMethod.equals(Object.class.getMethod("toString"))) {
                    ...
                    result = "ClientProxy for resource: " + clientResource;
                        ...
                        .getMethod("getEnrichedClientResource"))) {
