...
public class MessageParser {
    ...
    static public void parseMessage(Message msg, Vector<ITSCallback> listeners) throws MalformedMessageException, UnsupportedTemplateException {
    	if(msg != null) {
    ...
    static private void parseQuery(Message msg, Vector<ITSCallback> listeners) throws MalformedMessageException, UnsupportedTemplateException {    	
   		final Template selector = parseSelector(msg);
   		for(int i=0; i<listeners.size(); i++)
			listeners.elementAt(i).query(selector);
    }
    
    static private void parseQueryMultiple(Message msg, Vector<ITSCallback> listeners) throws MalformedMessageException, UnsupportedTemplateException {
    	try {
    ...
    static private void parseRead(Message msg, Vector<ITSCallback> listeners) throws MalformedMessageException, UnsupportedTemplateException {
    	MessageElement msgElement = msg.getMessageElement(null,Properties.GRAPHURI);
    	if( msgElement!=null ) {
    		for(int i=0; i<listeners.size(); i++)
    ...
    static private void parseTake(Message msg, Vector<ITSCallback> listeners) throws MalformedMessageException, UnsupportedTemplateException {
    	MessageElement msgElement = msg.getMessageElement(null,Properties.GRAPHURI);
    	if( msgElement!=null ) {
    		for(int i=0; i<listeners.size(); i++)
    ...
    static private void parseSuggest(Message msg, Vector<ITSCallback> listeners) throws MalformedMessageException, UnsupportedTemplateException {
