...
import otsopack.otsoME.network.communication.demand.remote.IRemoteDemandManager;
...
import otsopack.otsoME.network.communication.incoming.ResponseManager;
...
public class SpaceManager implements ISpaceInformationHolder {
    ...
    public void startup() throws IOException {    	
    	...
    	outcoming = new OutcomingManager(pipe, inbox, controller.getNetworkService());
   		incoming = new ResponseManager(controller, inbox, subscriptions,
   										remoteDemandMngr, localDemandMngr,
   										outcoming, this);
