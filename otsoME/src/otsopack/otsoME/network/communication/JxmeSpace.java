...
public class JxmeSpace implements PipeMsgListener, IMessageSender {	
	...
	private void createPipe() throws IOException {
		...
		if (pipeAdvertisement == null) {
			...
			log.debug(Priority.INFO, "Pipe (" + this.spaceURI + ") found.");
		}
