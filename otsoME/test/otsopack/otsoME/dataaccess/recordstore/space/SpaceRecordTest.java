...
public class SpaceRecordTest extends TestCase {
	...
	public void setUp() throws Throwable {
		...
		graphuris[0] = space.write(triples.write(SemanticFormats.NTRIPLES));
		...
		graphuris[1] = space.write(triples.write(SemanticFormats.NTRIPLES));
		...
		graphuris[2] = space.write(triples.write(SemanticFormats.NTRIPLES));
		...
		graphuris[3] = space.write(triples.write(SemanticFormats.NTRIPLES));
	...
	protected void testWrite() throws TripleParseException {
		...
		triples.addTriple( ExampleME.subj1,ExampleME.prop4,ExampleME.obj4);
		triples.addTriple( ExampleME.subj1,ExampleME.prop5,ExampleME.obj6);
		space.write(triples.write(SemanticFormats.NTRIPLES));
	}
